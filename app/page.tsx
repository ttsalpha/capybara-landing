...
const HOMEBREW_INSTALL_CMD = "brew install ttsalpha/tap/capybara";
const DOWNLOAD_URL = process.env.NEXT_PUBLIC_DOWNLOAD_URL as string;
...
const slides: Slide[] = [
  ...
  {
    title: "JWT Decoder",
    description: "Decode and inspect JWT tokens with header and payload display",
    image: "/6.png",
  },
];
...
export default function Home() {
  ...
  const goToSlide = (index: number) => {
    ...
    setIsAutoPlay(false);
    setTimeout(() => setIsAutoPlay(true), AUTOPLAY_INTERVAL_MS);
  };

  const handleCopyHomebrew = async () => {
    try {
      await navigator.clipboard.writeText(HOMEBREW_INSTALL_CMD);
    } catch {
    ...
    <main className="main">
      <section className="hero">
        <div>
          <div className="hero-icon">
            <a href="/" aria-label="Go to home" className="title-link">
              <img src="/app-icon.png" alt="Capybara Icon" className="capybara-icon" />
            </a>
          </div>
          <h1>
          ...
          <div className="btn-group">
            <a href="https://github.com/ttsalpha/Capybara" target="_blank" rel="noopener noreferrer" className="btn">
              <img src="/icons/star.svg" alt="Star" className="icon" />
              Star on GitHub
            </a>
            <a
              href="https://github.com/ttsalpha/Capybara/fork"
              target="_blank"
              rel="noopener noreferrer"
              className="btn"
            >
              <img src="/icons/fork.svg" alt="Fork" className="icon" />
              Fork on GitHub
            </a>
          </div>
        </div>
      ...
      <section className="installation-section">
        ...
        <div className="installation-methods">
          <div className="installation-method">
            ...
            <a href={DOWNLOAD_URL} target="_blank" rel="noopener noreferrer" className="btn btn-lg">
              Download
            </a>
          </div>
          <div className="installation-method">
            ...
            <div className="code-block">
              <code>brew install ttsalpha/tap/capybara</code>
              <button
                type="button"
                className="icon-button"
                aria-label="Copy install command"
                onClick={handleCopyHomebrew}
              >
                <img src="/icons/copy.svg" alt="" className="icon" />
              </button>
            </div>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="footer-content">
          <p>
            © 2025 Capybara.{" "}
            <a href="https://ttsalpha.com" target="_blank" rel="noopener noreferrer" className="link-plain">
              Son Tran
            </a>
            .
          </p>
